...
$loginmsg='Συμπληρώστε τα παρακάτω πεδία και πατήστε Προβολή Κατάστασης';
...
$URL = explode ("app",$_SERVER[SCRIPT_FILENAME]);
$base=  $URL[0];
require($base.'/app/include/client/header2.inc.php'); 
require($base.'/app/include/client/login.inc.php');
require($base.'/app/include/client/footer2.inc.php');
