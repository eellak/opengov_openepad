...
<div class="rslider">
    ...
    <script src="./js/jquery.ui.datepicker-el.js" type="text/javascript"></script>
	<script type="text/javascript" src="js/citizenform.js"></script>
	<script type="text/javascript">
	$(function() {

		prepareform();
		$("#citizenform").validationEngine(); 
	...
	{
		if ($('#yphresia_dimos_id').val()=='')	
		{
			alert("Πληκρολογήστε τον δήμο που εδρεύει η υπηρεσία ή επιλέξτε από την αναδυόμενη λίστα");
			return false; 
		}
		else 
		{
	...
	<div class="singlebig">
		<form class="form gen_forms" id="citizenform" action="index.php" method="post" enctype="multipart/form-data" onsubmit="return validateHidden();">
						...
						<div class="report_row">
						 ...
						 <div class="report_left">
					        ...
					        <div class="report_row">
                               ...
                               <h4>Ιδιότητα<span class="example"> (Με την οποία υποβάλλεται το μήνυμα)  </span></h4>
                            ...
                            <div class="report_row" id="namedata_default">
					            <h4><a href="#" class="show-more" id="namedata_toggle">Επιθυμώ Επώνυμη Επικοινωνία: </a><span class="example"><a target="_blank" href="?page_id=15">(Μάθε περισσότερα)</a></span></h4>
							...
							<div class="report_row">
                               ...
                               <h4>Λόγος Επικοινωνίας<span class="example"> </span></h4>		        
								...
								<br />	<br />	<h4><span class="example">Κατηγοριοποιείστε το μήνυμά σας ανάλογα με την προηγούμενη επιλογή:</span> </h4>      
                            ...
                            <!-- date -->
                            <div class="report_row">
					        <h4>Ημερομηνία που αφορά το μήνυμα<span class="example">  (Υποχρεωτικό πεδίο)</span></h4>
					        <input type="text" id="eventdate" name="eventdate"   onblur="$('#eventdate').validationEngine('hidePrompt');" onclick="$('#eventdate').validationEngine('showPrompt', 'Συμπληρώστε την ημερομηνία συμβάντος.', 'load',true)" value="<? echo date('d/m/Y'); ?>"/>			
                            </div>
							<script type="text/javascript">
								$.datepicker.setDefaults( $.datepicker.regional[ "" ] );
								$( "#eventdate" ).datepicker( $.datepicker.regional[ "el" ] );
							</script>
					        ...
					        <br />*Τα μηνύματα που εκγρίνονται σύμφωνα με το πλαίσιο συμμετοχής αναρτώνται στη διεύθυνση <ahref="/archive/">/archive</a></span></h4>
                            ...
                            <div class="report_right">
				                ...
				                <div id="divyphresia_dimos" class="report_row">
                                    ...
                                    <h4>Εδρα Υπηρεσίας</h4>
                                     <input name="yphresia_dimos" id="yphresia_dimos" type="text"  class="text long validate[required]"  onblur="$('#yphresia_dimos').validationEngine('hidePrompt');" onclick="$('#yphresia_dimos').validationEngine('showPrompt', 'Πληκρολογήστε τον δήμο που εδρεύει η υπηρεσία ή επιλέξτε από την αναδυόμενη λίστα', 'load',true)"  value="" title="Δώστε την Πόλη ή τον Δήμο που εδρεύει η υπηρεσία"/>
				...
				<input type="hidden" name="yphresia_dimos_id" id="yphresia_dimos_id" class="validate[required]" value="" />
				<!--  Hidden fileds [End] --> 
...
<?php require(CLIENTINC_DIR.'footer2.inc.php'); ?>
