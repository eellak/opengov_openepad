...
$nav->addSubMenu(array('desc'=>'Προφίλ','href'=>'profile.php','iconclass'=>'user'));
$nav->addSubMenu(array('desc'=>'Επιλογές','href'=>'profile.php?t=pref','iconclass'=>'userPref'));
$nav->addSubMenu(array('desc'=>'Αλλαγή Κωδικού','href'=>'profile.php?t=passwd','iconclass'=>'userPasswd'));
//Warnings if any.
if($thisuser->onVacation()){
        $warn.='Καλώς ήρθατε! Ο λογαριασμός σας είναι σε κατάσταση  \'διακοπών\' Παρακαλώ ενημερώστε τον Διαχειριστή ή τον Προιστάμενο σας ότι επιστρέψατε.';
}
