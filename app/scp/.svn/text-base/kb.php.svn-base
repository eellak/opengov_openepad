...
if($_POST):
    ...
    case 'process':
        if(!$_POST['canned'] || !is_array($_POST['canned']))
            ...
            if(!$msg)
                $errors['err']='Κάποιο λάθος εμφανίστηκε. Παρακαλώ ξαναδοκιμάστε';
        }
        break;
    default:
...
$nav->addSubMenu(array('desc'=>'Πρότυπα απαντήσεων','href'=>'kb.php','iconclass'=>'premade'));
$nav->addSubMenu(array('desc'=>'Νεό πρότυπο απάντησης','href'=>'kb.php?a=add','iconclass'=>'newPremade'));
