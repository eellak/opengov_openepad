 ...
 <table width="100%" border="0" cellspacing=1 cellpadding=2>
    ...
    <tr><td>
     <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        ...
        if($users && db_num_rows($users)):
            ...
            <tr class="<?=$class?>"><td colspan=8><b>Το ερώτημα δεν επέστρεψε αποτελεέσματα</b></td></tr>
        <?
        endif; ?>
     </table>
    </td></tr>
    ...
    <tr><td>
        <div style="margin-left:20px;">
            Select:&nbsp;
            <a href="#" onclick="return select_all(document.forms['staff'],true)">Όλα</a>&nbsp;&nbsp;
            <a href="#" onclick="return toogle_all(document.forms['staff'],true)">Ενναλαγή</a>&nbsp;&nbsp;
            <a href="#" onclick="return reset_all(document.forms['staff'])">Κανένα</a>&nbsp;&nbsp;
        </div>
    </td></tr>
    <tr><td align="center">
        ...
        <input class="button" type="submit" name="disable" value="Κλείδωμα" 
