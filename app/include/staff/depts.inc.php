...
<table width="100%" border="0" cellspacing=1 cellpadding=2>
    ...
    <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        <tr>
	        ...
	        <th>Όνομα Φορέα</th>
            <th>Εμφάνιση</th>
            <th width=10>Χρήστες</th>
            <th>Εξερχόμενο email</th>
            <th>Διαχειριστής</th>
        </tr>
        <?
        $class = 'row1';
        ...
        if($depts && db_num_rows($depts)):
            ...
            <tr class="<?=$class?>" id="<?=$row['dept_id']?>">
                ...
                <td><?=$row['ispublic']?'Δημόσια Εμφάνιση':'<b>Εσωτερική Εμφάνιση</b>'?></td>
                <td>&nbsp;&nbsp;
                    <b>
                    <?if($row['users']>0) {?>
            ...
            <tr class="<?=$class?>"><td colspan=6><b>Η Αναζήτηση δεν επέστρεψε αποτελέσματα</b></td></tr>
        <?
        endif; ?>
    </table>
    </td></tr>
    ...
    <tr>
        <td style="padding-left:20px">
            Select:&nbsp;
            <a href="#" onclick="return select_all(document.forms['depts'],true)">Όλα</a>&nbsp;&nbsp;
            <a href="#" onclick="return reset_all(document.forms['depts'])">Κανένα</a>&nbsp;&nbsp;
            <a href="#" onclick="return toogle_all(document.forms['depts'],true)">Ενναλαγή</a>&nbsp;&nbsp;
        </td>
    </tr>
    <tr>
        <td align="center">
            <input class="button" type="submit" name="public" value="Δημόσια Εμφάνιση"
                onClick=' return confirm("Are you sure you want to make selected depts(s) public?");'>
            <input class="button" type="submit" name="private" value="Εσωτερική Εμφάνιση" 
                onClick=' return confirm("Are you sure you want to make selected depts(s) private?");'>
            <input class="button" type="submit" name="delete" value="Διαγραφή Φορέα" 
