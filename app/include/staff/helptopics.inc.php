...
?>
<div class="msg">Είδη Επικοινωνίας</div>
   ...
   <tr><td>
    <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        ...
        if($services && db_num_rows($services)):
            ...
            <tr class="<?=$class?>"><td colspan=8><b>Η αναζήτηση δεν επέστρεψε αποτελέσματα</b></td></tr>
        <?
        endif; ?>
    </table>
    </td></tr>
    ...
    <tr>
        <td style="padding-left:20px">
            Select:&nbsp;
            <a href="#" onclick="return select_all(document.forms['topic'],true)">Όλα</a>&nbsp;&nbsp;
            <a href="#" onclick="return reset_all(document.forms['topic'])">Κανένα</a>&nbsp;&nbsp;
            <a href="#" onclick="return toogle_all(document.forms['topic'],true)">Ενναλαγή</a>&nbsp;&nbsp;
        </td>
    </tr>
    <tr>
        <td align="center">
