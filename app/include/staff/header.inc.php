...
<link type="text/css" href="../styles/ui-lightness/jquery-ui-1.8.9.custom.css" rel="stylesheet" />
<link type="text/css" href="../styles/jquery.ui.selectmenu.css" rel="stylesheet" />
...
<div id="container">
    <div id="header">
        ...
        <p id="info">Καλωσήλθες, <strong><?=$thisuser->getUsername()?></strong> 
           <?php
            if($thisuser->isAdmin() && !defined('ADMINPAGE')) { ?>
            | <a href="admin.php">Λειτουργίες Διαχειριστή</a>  
            <?}else{?>
            | <a href="index.php">Λειτουργίες Χρήστη</a>
            <?}?>
            | <a href="profile.php?t=pref">Οι Ρυθμίσεις μου</a> | <a href="logout.php">Αποσύνδεση</a></p>
    </div>
    <div id="nav">
        <ul id="main_nav" <?=!defined('ADMINPAGE')?'class="dist"':''?>>
            ...
            <?}
                ...
                <li><a href="profile.php" title="My Preference">Ο Λογαρισμός μου</a></li>
            <?}?>
        </ul>
        <ul id="sub_nav">
            <?php
