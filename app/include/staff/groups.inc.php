...
<table width="100%" border="0" cellspacing=1 cellpadding=2>
    ...
    <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        <tr>
	        <th width="7px">&nbsp;</th>
	        <th width=200>Όνομα Ομάδας</th>
            <th width=100>Κατάσταση Ομάδας</th>
	        <th width=10>&nbsp;Μέλη</th>
        ...
        if($groups && db_num_rows($groups)):
            ...
            <tr class="<?=$class?>"><td colspan=6><b>Η αναζήτηση δεν επεστρεψε αποτελέσματα</b></td></tr>
        <?
        endif; ?>
    </table>
    <?
    ...
    <tr>
        <td style="padding-left:20px;">
            Select:&nbsp;
            <a href="#" onclick="return select_all(document.forms['groups'],true)">Όλα</a>&nbsp;&nbsp;
            <a href="#" onclick="return toogle_all(document.forms['groups'],true)">Εναλλαγή</a>&nbsp;&nbsp;
            <a href="#" onclick="return reset_all(document.forms['groups'])">Κανένα</a>&nbsp;&nbsp;
        </td>
    </tr>
    <tr>
        <td align="center">
            <input class="button" type="submit" name="activate_grps" value="Ενεργοποιήση" 
                onClick=' return confirm("Are you sure you want to ENABLE selected group(s)");'>
            <input class="button" type="submit" name="disable_grps" value="Απενεργοποιήση" 
                onClick=' return confirm("Are you sure you want to DISABLE selected group(s)");'>
            <input class="button" type="submit" name="delete_grps" value="Διαγραφή" 
