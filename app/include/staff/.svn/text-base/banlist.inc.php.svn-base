...
$result_type=($search)?'Αποτελέσματα Αναζήτησης':'Αποκλεισμένα Email';
...
<div id='add' style="display:<?=$showadd?'block':'none'?>;" align="left">
    ...
    <input type="submit" name="add" class="button" value="Add">
     &nbsp;<a href="#" class="msg" onClick="showHide('add','search'); return false;">(Αναζήτηση)</a>
    </form>
</div>
   ...
   <tr><td>
    <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        <tr>
	        ...
	        <th width=200 >Υποβάλλων</th> 
	        <th width=150 nowrap>
                <a href="admin.php?t=banlist&sort=date&order=<?=$negorder?><?=$qstr?>" title="Sort By Create Date <?=$negorder?>"Ημερομηνία Προσθήκης</a></th>
        </tr>
        <?
        $class = 'row1';
        $total=0;
        ...
        if($banlist && db_num_rows($banlist)):
            ...
            <tr class="<?=$class?>"><td colspan=4><b>Η αναζήτηση δεν επεστρέψε αποτελέσματα</b>&nbsp;&nbsp;<a href="admin.php?t=banlist">Index list</a></td></tr>
        <?
        endif; ?>
     </table>
    </td></tr>
    ...
    <tr>
        <td style="padding-left:20px">
            Select:&nbsp;
            <a href="#" onclick="return select_all(document.forms['banlist'],true)">Όλα</a>&nbsp;&nbsp;
            <a href="#" onclick="return toogle_all(document.forms['banlist'],true)">Ενναλαγή</a>&nbsp;&nbsp;
            <a href="#" onclick="return reset_all(document.forms['banlist'])">Κανένα</a>&nbsp;&nbsp;
    ...
    <tr>
        <td align="center">
            <input class="button" type="submit" name="delete" value="Remove From List" 
                     onClick='return confirm("Είστε σίγουρος για την ΔΙΑΓΡΑΦΗ του επιλεγμένου email από τη λίστα αποκλεισμένων ;");'>
        </td>
    </tr>
    <?
    endif;
