...
function wp_unregister_GLOBALS() {
	...
	if ( isset( $_REQUEST['GLOBALS'] ) )
		die( /*WP_I18N_GLOBALS_OVERWRITE*/'Απόπειρα αντικατάστασης GLOBALS!'/*/WP_I18N_GLOBALS_OVERWRITE*/ );
...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) )
		die( sprintf( /*WP_I18N_OLD_PHP*/'Ο διακομιστής σας έχει PHP έκδ. %1$s, ενώ το WordPress %2$s απαιτεί τουλάχιστον %3$s.'/*/WP_I18N_OLD_PHP*/, $php_version, $wp_version, $required_php_version ) );

	if ( !extension_loaded( 'mysql' ) && !file_exists( WP_CONTENT_DIR . '/db.php' ) )
		die( /*WP_I18N_OLD_MYSQL*/'Η εγκατάσταση PHP φαίνεται ότι δεν έχει την επέκταση της MySQL που απαιτείται από το WordPress.'/*/WP_I18N_OLD_MYSQL*/ );
}
...
?>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title><?php echo /*WP_I18N_MAINTENANCE*/'Συντήρηση'/*/WP_I18N_MAINTENANCE*/; ?></title>

	</head>
	<body>
		<h1><?php echo /*WP_I18N_MAINT_MSG*/'Αυτή τη στιγμή γίνεται συντήρηση.  Δοκιμάστε πάλι σ’ ένα λεπτό.'/*/WP_I18N_MAINT_MSG*/; ?></h1>
	</body>
	</html>
<?php
	die();
...
function wp_set_wpdb_vars() {
	...
	if ( is_wp_error( $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'ΣΦΑΛΜΑ: Το <code>$table_prefix</code> στο <code>wp-config.php</code> επιτρέπειται να περιέχει μόνο αριθμούς, γράμματα και κάτω παύλες.'/*/WP_I18N_BAD_PREFIX*/ );
}
