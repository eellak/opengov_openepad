...
// $base sanity check.
if ( 'BASE' == $base )
	die( /*WP_I18N_BASE_ERROR*/'Σφάλμα διαρρύθμισης στο <code>wp-config.php</code>.  Το <code>$base</code> έχει τιμή <code>BASE</code>, ενώ πρέπει να είναι <code>/</code> ή <code>/blogs/</code>.'/*/WP_I18N_BASE_ERROR*/ );
...
if ( !isset( $current_site ) || !isset( $current_blog ) ) {
	...
	if ( ! $blog_id ) {
		if ( defined( 'WP_INSTALLING' ) ) {
			...
			$msg = ! $wpdb->get_var( "SHOW TABLES LIKE '$wpdb->site'" ) ? ' ' . /*WP_I18N_TABLES_MISSING*/'Απουσιάζουν πίνακες της βάσεις δεδομένων.'/*/WP_I18N_TABLES_MISSING*/ : '';
			wp_die( /*WP_I18N_NO_BLOG*/'Δεν υπάρχει ιστότοπος με τέτοιο όνομα στο σύστημα!'/*/WP_I18N_NO_BLOG*/ . $msg );
		}
	}
}
