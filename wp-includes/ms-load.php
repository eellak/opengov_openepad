...
function wpmu_current_site() {
	...
	// Still no dice.
	if ( 1 == count( $sites ) )
		wp_die( sprintf( /*WP_I18N_BLOG_DOESNT_EXIST*/'Ο ιστότοπος δεν υπάρχει.  Δοκιμάστε το <a href="%s">%s</a>.'/*/WP_I18N_BLOG_DOESNT_EXIST*/, $sites[0]->domain . $sites[0]->path ) );
	else
...
function ms_not_installed() {
	...
	$title = /*WP_I18N_FATAL_ERROR*/'Σφάλμα κατά τη σύνδεση με βάση δεδομένων'/*/WP_I18N_FATAL_ERROR*/;
	$msg  = '<h1>' . $title . '</h1>';
	if ( ! is_admin() )
		die( $msg );
	$msg .= '<p>' . /*WP_I18N_CONTACT_OWNER*/'Αν ο ιστότοπός σας δεν εμφανίζεται, επικοινωνήστε με τον διαχειριστή του δικτύου αυτού.'/*/WP_I18N_CONTACT_OWNER*/ . '';
